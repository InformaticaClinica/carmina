...
class BenchmarkRunner:
    ...
    Attributes:
        ...
        strategy (str): The strategy to use during execution, loaded from the "STRATEGY" environment variable.
    ...
    def __init__(self):
        ...
        self.strategy = os.getenv("STRATEGY", "label")
        self.input_path = os.getenv("INPUT", "data/input.json")
    ...
    def run(self):
        ...
        Attributes:
            ...
            strategy (str): The execution strategy to be used for the models.
