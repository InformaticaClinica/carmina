...
class TestDeepSeekStrategy:
    ...
    def mock_deepseek_strategy(self):
        ...
        strategy = DeepSeekStrategy(model_name="deepseek-r1", cloud_provider=mock_cloud_provider)
        return strategy
    ...
    def deepseek_strategy(self):
        ...
        return DeepSeekStrategy(model_name="deepseek-r1", cloud_provider=azure_provider)
    ...
    def test_azure_identification_mode(self, deepseek_strategy, sample_medical_records):
