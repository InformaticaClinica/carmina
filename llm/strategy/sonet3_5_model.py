...
class Sonet3_5Model(LLMStrategy):
    def __init__(self):
        super().__init__()
        self._client = boto3.client('bedrock-runtime', region_name='us-east-1', config=config)
        self._model_id = "anthropic.claude-3-5-sonnet-20240620-v1:0"
